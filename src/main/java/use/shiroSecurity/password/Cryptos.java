 ...
 */
package use.shiroSecurity.password;
...
public class Cryptos {
	...
	private static final int DEFAULT_DES_KEYSIZE = 128;
	...
	/**
	 * 生成DES密钥,返回字节数组, 默认长度为128位(16字节).
	 */
	public static byte[] generateDesKey() {
		return generateAesKey(DEFAULT_DES_KEYSIZE);
	}

	/**
	 * 生成DES密钥,可选长度为128,192,256位.
	 */
